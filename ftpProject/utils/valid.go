...
func (v *valid) checkallnum(s string, args ...int) bool {
	...
	if len(args) == 2 {
		if args[1]-args[0] < 0 {
			logs.Error("checkallnum  第二个数字参数应该大于等于第一个")
			return false
		}
...
func (v *valid) checkhanumber(s string, args ...int) bool {
	...
	if len(args) == 2 {
		if args[1]-args[0] < 0 {
			logs.Error("checkhanumber  第二个数字参数应该大于等于第一个")
			return false
		}
		min = args[0]
		max = args[1]
...
func (v *valid) checkOrderAlpNumber(s string, args ...int) bool {
	if len(args) > 2 {
		logs.Error("checkOrderAlpNumber  参数错误")
		return false
	}
	min := 1
	max := 999
	if len(args) == 2 {
		if args[1]-args[0] < 0 {
			logs.Error("checkOrderAlpNumber  第二个数字参数应该大于等于第一个")
			return false
		}
		min = args[0]
		max = args[1]
...
func (v *valid) checkwordnumber(s string, args ...int) bool {
	if len(args) > 2 {
		logs.Error("checkwordnumber  参数错误")
		return false
	}
	min := "1"
	max := "999"
	if len(args) == 2 {
		if args[1]-args[0] < 0 {
			logs.Error("checkwordnumber  第二个数字参数应该大于等于第一个")
			return false
		}
		min = strconv.Itoa(args[0])
		max = strconv.Itoa(args[1])
...
func (v *valid) checkfloat(s string, args ...int) bool {
	...
	if len(args) == 2 {
		if args[1]-args[0] < 0 {
			logs.Error("checkfloat  第二个数字参数应该大于等于第一个")
			return false
		}
...
func (v *valid) checkhan(s string, args ...int) bool {
	...
	if len(args) == 2 {
		if args[1]-args[0] < 0 {
			logs.Error("checkhan  第二个数字参数应该大于等于第一个")
			return false
		}
		min = strconv.Itoa(args[0])
		max = strconv.Itoa(args[1])
...
func (v *valid) checkHanAndWord(s string, args ...int) bool {
	if len(args) > 2 {
		logs.Error("checkHanAndWord 参数错误")
		return false
	}
	var min = "1"
	var max = "999"
