...
func MonthsBetween(start string, end string) (int, int) {
	return 0, 0
}

func NextNode(start string) string {
	return ""
}

func LastNode(start string) string {
	return ""
}
